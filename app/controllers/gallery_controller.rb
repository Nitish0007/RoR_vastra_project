class GalleryController < ApplicationController
  ...
  def checkout
         ...
         credit_card = ActiveMerchant::Billing::CreditCard.new(
            ...
            gateway =ActiveMerchant::Billing::TrustCommerceGateway.new(
             ...
             if response.success?
              ...
              flash[:notice]="Thank You for using Vastra. The order details are sent to your mail"
                session[:cart_id]=nil
                session[:amount]=nil
    ...
    def search
      ...
      @products = Store.where("title LIKE :k or  category LIKE :k or description LIKE :k", k:"#{keyword}")
      end
